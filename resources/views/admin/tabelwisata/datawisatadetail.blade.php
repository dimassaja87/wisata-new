...
<head>
    ...
    <meta charset="utf-8" />
    <title>Data Wisata Detail | Admin</title>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    <div class="edit">
                                                                        <a href="/tampildetailwisata/{{ $row->id }}"
                                                                            class="btn btn-sm btn-success edit-item-btn">Edit</a>
                                                                    </div>
                                                                    <div class="remove">
                                                                        <a href="#"
                                                                            data-id="{{ $row->id }}"
                                                                            data-nama="{{ $row->detail_wisata }}"
...
<script>
    $('.deletedetailwisata').click(function() {
        var detailwisataid = $(this).attr('data-id');
        var detail_wisata = $(this).attr('data-nama');
        swal({
                title: "Anda yakin?!",
                text: "Ingin menghapus data dengan nama " + detail_wisata + " ",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deletedetailwisata/" + detailwisataid + ""
