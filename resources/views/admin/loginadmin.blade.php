...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Administrator</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input"
                                                    name="password" placeholder="Masukkan Password" id="password-input">
                                                <button
    ...
    <!-- JAVASCRIPT -->
    <script src="{{ asset('admin/themesbrand.com/velzon/html/default/assetslibs/bootstrap/js/bootstrap.bundle.min.js') }}">
    </script>
    ...
    <script src="{{ asset('admin/themesbrand.com/velzon/html/default/assetslibs/feather-icons/feather.min.js') }}">
    </script>
    <script src="{{ asset('admin/themesbrand.com/velzon/html/default/assetsjs/pages/plugins/lord-icon-2.1.0.js') }}">
    </script>
