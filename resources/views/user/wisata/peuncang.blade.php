                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mg_blog_detail_wrap">
                                    ...
                                    <div class="mg_blog_full">
                                        <h5 class="blog_title"><a>Pulau wisata Peuncang Banten</a></h5>
                                        <div class="thumb">
                                        ...
                                        <div class="mg_blog_contant">
                                            <div class="thumb">
                                            <p>Pulau Peucang adalah pulau kecil yang masuk dalam wilayah Pandeglang, Banten. Pulau ini berada di utara Taman Nasional Ujung Kulon. Sebagai bagian dari taman nasional tersebut Pulau Peucang menawarkan berbagai sajian alam memukau. Ditambah dengan keindahan taman bawah lautnya menjadi daya tarik utama pariwisata pulau ini.</p>
                                            <br><h5>Cara Ke Pulau Peucang</h5></br>
                                            <p>Untuk menuju Pulau Peucang jika menggunakan kendaraan pribadi, wisatawan bisa melalui tol Jakarta – Merak. Opsi lainnya yaitu menggunakan tol Jakarta – Tangerang. Dari Tol, lanjutkan ke Jalan Pandeglang hingga Kecamatan Sumur. Penyeberangan berangkat dari Kecamatan Sumur menggunakan kapal ke Pulau Peucang.</p>
                                            <p>Wisatawan juga bisa memilih opsi mengikuti paket wisata open trip. Paket ini biasanya sudah termasuk transportasi antar-jemput dari Jakarta dan penginapan. Tidak hanya itu, peserta pun bisa ikut eksplorasi spot wisata di wilayah Taman Ujung Kulon. Open trip bisa jadi pilihan bagi mereka yang tidak ingin repot dalam hal jadwal aktivitas.</p>
                                        <img src="https://travelspromo.com/wp-content/uploads/2021/09/Panorama-dari-Mercusuar-Bagus-Reza-Erlangga-1362x908.jpg.webp" alt="">
                                            </div>
                                        <br><h5 class="blog_main_title">Harga Tiket Masuk</h5></br>
                                            <div class="mg_table">
                                                ...
                                                <ul>
                                                    <li>Open Trip Pulau Peucang</li>
                                                    <li>mulai dari Rp650.000</li>
                                                </ul>
                                            </div>
                                            <br><h5>Fasilitas</h5></br>
                                            <p>Area pulau ini sudah memiliki fasilitas yang lengkap dan memadai. Fasilitas tersebut yaitu kapal penyeberangan, penginapan, dan toilet umum dengan air bersih. Jika mengikuti paket open trip, biasanya wisatawan mendapatkan peralatan snorkeling atau memancing.</p>
                        </div>
