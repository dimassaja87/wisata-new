                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mg_blog_detail_wrap">
                                ...
                                <div class="mg_blog_full">
                                    ...
                                    <div class="thumb">
                                        <img src="https://travelspromo.com/wp-content/uploads/2021/09/Pulau-Peucang-Andini-Maheswari.jpg"
                                            alt="">
                                    </div>
                                    <div class="mg_blog_contant">
                                        <div class="thumb">
                                            <p>Pura Tanah Lot adalah salah satu Pura yang sangat disucikan di Bali,
                                                Indonesia. Di sini ada dua pura yang terletak di atas batu besar. Satu
                                                terletak di atas bongkahan batu dan satunya terletak di atas tebing
                                                mirip dengan Pura Uluwatu. Pura Tanah Lot merupakan pura laut tempat
                                                pemujaan dewa-dewa penjaga laut. Tanah Lot terkenal sebagai tempat yang
                                                indah untuk melihat matahari terbenam, sehingga bisa digunakan tempat
                                                wisata juga.</p>
                                            <br>
                                            <h5>Cara Ke Tanah Lot</h5></br>
                                            <p>Jarak dari bandara Internasional Ngurah Rai sektar 27 km dengan waktu
                                                tempuh 1,5 jam. pengunjung bisa ambil rute ke Jl. Bandara Ngurah Rai-Jl.
                                                By Pass Ngurah Rai-Jl. Sunset Road-Jl. Raya Canggu- Jl. By Pass Tanah
                                                Lot-Jl.Raya Tanah Lot di Beraban, kemudian Anda akan sampai di Tanah
                                                Lot.</p>
                                            <p>Berkunjung ke Pura Tanah Lot lebih nyaman menggunakan kendaraan pribadi,
                                                transportasi online atau sewa kendaraan, mengingat terbatasnya
                                                transportasi umum di Bali.</p>
                                            <img src="https://tourisonn.com/wp-content/uploads/2019/12/TANAH-LOT-TEMPLE-1024x683.jpg"
                                                alt="">
                                        </div>
                                        <br>
                                        <h5 class="blog_main_title">Harga Tiket Masuk</h5></br>
                                        <div class="mg_table">
                                        ...
                                        <br>
                                        <h5>Keunikan dan daya tarik</h5></br>
                                        <p>Pura Tanah Lot memiliki beragam keunikan dan daya tarik,diantaranya memiliki
                                            banyak pura, gua air suci dan gua ular suci. Di tanah lot juga cocok
                                            digunakan sebagai spot foto, melihat matahari tenggelam dan bermain air</p>
                                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="mg_comment_dec">
                                                    <figure><img src="{{ asset('$row->profile') }}" alt="">
                                                    </figure>
                                                    <div class="overflow_text">
                                                        <h6>{{ $row->nama }}</h6>
                                                        <p>{{ $row->email }}</p>
                                                        <img src="{{ asset('fotokomen/' . $row->foto) }}"
                                                ...
                                                <ul class="children">
                                                    <li>
                                                        <div class="mg_comment_dec">
                                                            <figure><img
                                                                    src="{{ asset('iqoniq/iconic-themes.com/html/iqoniqtravel/iqoniq-travel-light/extra-images/comment_user1.jpg') }}"
                                                                    alt=""></figure>
                                                            <div class="overflow_text">
                                                                <h6><a href="#">john doe</a><span>( JUNE 20, 2014
                                                                        )</span></h6>
                                                                <p>Nihilne te nocturnum praesidium Palati, nihil urbis
                                                                    vigiliae. Non equidem invideo, miror magis posuere
                                                                    velit aliquet. Qui ipsorum lingua Celtae, nostra
                                                                    Galli appellantur. Prima luce, cum quibus mons aliud
                                                                    consensu ab eo. </p>
                                                            </div>
                                                        </div>
                                                    </li>
                            ...
                            <div class="mg_sidebar">
                                ...
                                <div class="widget widget_recent_post">
                                    <div class="border-bottom">
                                        ...
                                        <div class="recent_post fancy-overlay">
                                            <figure><img
                                                    src="https://res.klook.com/image/upload/fl_lossy.progressive,q_85/c_fill,w_1000/v1601460678/blog/fn6axuxtktmf0qhgykmc.webp"
                                                    alt=""></figure>
                                            <div class="overflow_text">
                                                <h5><a href="/kawah">Kawah Putih Ciwidey</a> <span><i
                                                            class="fa fa-clock"></i></span></h5>
                                                <p>Wisata Kawah Putih Ciwidey cocok untuk kalian yang suka berswafoto
                                                    dan cuci mata.</p>
                                            </div>
                                        </div>
                                        <!-- Recent Post End -->
                                        ...
                                        <div class="recent_post fancy-overlay">
                                            <figure><img
                                                    src="https://res.klook.com/image/upload/fl_lossy.progressive,q_85/c_fill,w_1000/v1604304682/blog/ywholpnn3tydffdo1vql.webp"
                                                    alt=""></figure>
                                            <div class="overflow_text">
                                                <h5><a href="/lembang">Lembang Park & Zoo</a> <span><i
                                                            class="fa fa-clock"></i></span></h5>
                                                <p>Lembang Park & Zoo cocok untuk Anda yang ingin berlibur bersama
                                        ...
                                        <div class="recent_post fancy-overlay">
                                            <figure><img
                                                    src="https://bisniswisata.co.id/wp-content/uploads/2019/06/lawang-sewu-1068x712.jpg"
                                                    alt=""></figure>
                                            <div class="overflow_text">
                                                <h5><a href="/lawang">Lawang Sewu</a> <span><i
                                                            class="fa fa-clock"></i></span></h5>
                                                <p>Wisata Lawang Sewu cocok untuk Anda yang suka berwisata ke tempat
                                                    bersejarah.</p>
                                            </div>
                                        </div>
                                        <!-- Recent Post End -->
                                        ...
                                        <div class="recent_post fancy-overlay">
                                            <figure><img
                                                    src="https://1.bp.blogspot.com/-qU4HzJrCT7U/XTNzgkd3O8I/AAAAAAAAB40/upKm38Sf6gQCp7p0hfKvQqnCEYuqPqOnwCEwYBhgL/s1600/Wisata-Ayana-Gedongsongo-Semarang-Jawa-Tengah.jpg"
                                                    alt=""></figure>
                                            <div class="overflow_text">
                                                <h5><a href="/ayana">Ayana Gedong Songo</a> <span><i
                                                            class="fa fa-clock"></i></span></h5>
                                                <p>Ayana Gedong Songo cocok untuk Anda yang ingin berakhir pekan dengan
                                                    banyak spot foto dan instagramable.
                                                </p>
                                            </div>
                                        </div>
                                        <!-- Recent Post End -->
                                ...
                                <div class="widget widget_rss">
                                    <div class="border-bottom">
                                        ...
                                        <ul class="mg_rss_list">
                                            <li><span> John Doe on </span><a href="#">Magna pars studiorum</a>
                                            </li>
                                            <li><span> John Doe on </span><a href="#">Eiusmod tempor incidunt</a>
                                            </li>
                                            <li><span> John Doe on </span><a href="#">Donec luctus imperdiet</a>
                                            </li>
                                            <li><span> John Doe on </span><a href="#">Nihilne te nocturnum</a>
                                            </li>
                                            <li><span> John Doe on </span><a href="#">Magna pars studiorum</a>
                                            </li>
                                            <li><span> John Doe on </span><a href="#">Eiusmod tempor incidunt</a>
                                ...
                                <div class="mapouter">
                                    <div class="gmap_canvas"><iframe width="770" height="510" id="gmap_canvas"
                                            src="https://maps.google.com/maps?q=tanah lot,bali&t=&z=10&ie=UTF8&iwloc=&output=embed"
            ...
            <div class="modal-dialog login1 login5 login5-1">
                <div class="modal-tab">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#sign-In1" aria-controls="sign-In1"
                                role="tab" data-toggle="tab">Sign In</a></li>
                        <li role="presentation"><a href="#sign-up2" aria-controls="sign-up2" role="tab"
